...
public abstract class ExpirationPredicate implements IExpirationSupport, IElementSerializable {
	...
	protected static ExpirationPredicate basicCreate(IArgs args, String role, ExpirationPredicate defaultValue)
	...
	public static ExpirationPredicate create(IArgs args, ExpirationPredicate defaultValue)
			throws ObjectCreationException {
