 ...
 * {@link TlvElement} based objects that are composite (i.e. the
 * {@link TlvElement} is not primitive, but contains a {@link TlvTemplate}
 * itself).
 * 
 */
public abstract class TlvElementBasedComposite extends TlvElementBasedObject {
	...
	protected TlvElementBasedComposite(TlvElement element) {
		super(element);
