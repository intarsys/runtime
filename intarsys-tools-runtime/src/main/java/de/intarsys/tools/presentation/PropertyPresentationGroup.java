...
public class PropertyPresentationGroup extends PropertyPresentation {
	...
	private final List<PropertyPresentation> properties = new ArrayList<>();
	...
	public PropertyPresentationItem addProperty(String label, Object value) {
		PropertyPresentationItem p = new PropertyPresentationItem(getObject(), null, label, value, null);
		properties.add(p);
		return p;
	}

	public PropertyPresentationItem addProperty(String label, Object value, Format format) {
		PropertyPresentationItem p = new PropertyPresentationItem(getObject(), null, label, value, format);
		properties.add(p);
		return p;
	}

	public PropertyPresentationItem addPropertyDynamic(String name, String label) {
		PropertyPresentationItem p = new PropertyPresentationItem(getObject(), name, label);
		properties.add(p);
		return p;
	}

	public PropertyPresentationItem addPropertyDynamic(String name, String label, Format format) {
		PropertyPresentationItem p = new PropertyPresentationItem(getObject(), name, label, format);
		properties.add(p);
		return p;
	}
	...
	public PropertyPresentationItem setHeader(String label, Object value, Format format) {
		PropertyPresentationItem p = new PropertyPresentationItem(getObject(), null, label, value, format);
		header = p;
		return p;
	}
