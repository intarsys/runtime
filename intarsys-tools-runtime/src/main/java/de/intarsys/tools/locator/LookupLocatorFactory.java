...
public class LookupLocatorFactory extends CommonLocatorFactory {
	...
	public LookupLocatorFactory() {
	}

	public LookupLocatorFactory(ILocatorFactory... factories) {
		for (ILocatorFactory factory : factories) {
			this.addLocatorFactory(factory);
		}
	}
	...
	public void toString(PrettyPrinter printer) {
		...
		printer.appendMember("factories", factories, null);
	}
