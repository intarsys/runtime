 ...
 * 
 */
public class BeanPropertiesNode<T extends Object> extends PropertiesNode<T> {

	public BeanPropertiesNode(CommonNode parent, T object) {
		super(parent, object);
	}
	...
	protected void createPropertyNodes(List<CommonNode> properties) {
		try {
			...
			for (int i = 0; i < propertyDescriptors.length; i++) {
				...
				PropertyNode tempNode = new PropertyNode(this, getObject(), propertyDescriptor.getDisplayName(),
