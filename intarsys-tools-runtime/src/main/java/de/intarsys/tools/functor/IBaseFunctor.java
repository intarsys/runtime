...
public interface IBaseFunctor<T> {
	 ...
	 * 
	 * @param args The call context
	 * @return The behavior execution result.
	 * 
	 * @throws FunctorException An exception that raised while executing the
	 *                          business logic will be wrapped in a
	 *                          FunctorInvocationException.
	 */
	public T perform(Object... args) throws FunctorException;
}
