...
public class XMLSerializationTools {
	...
	public static byte[] serialize(ISerializationFactory factory, Object object, boolean createDocument)
			throws IOException {
		ByteArrayLocator locator = new ByteArrayLocator(null, "object", "xml");
		OutputStream os = null;
		try {
			os = locator.getOutputStream();
			XMLSerializationContext context = new XMLSerializationContext(os, createDocument);
